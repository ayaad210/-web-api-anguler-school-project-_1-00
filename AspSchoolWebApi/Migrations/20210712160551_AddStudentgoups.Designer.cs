...
namespace AspSchoolWebApi.Migrations
{
    ...
    [Migration("20210712160551_AddStudentgoups")]
    partial class AddStudentgoups
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupStudent", b =>
                {
                    b.HasOne("AspSchoolWebApi.Models.DbModels+Group", null)
                        .WithMany()
                        .HasForeignKey("Groupsid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AspSchoolWebApi.Models.DbModels+Student", null)
                        .WithMany()
